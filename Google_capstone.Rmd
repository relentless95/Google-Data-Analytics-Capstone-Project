...
```{r}
setwd("C:/Users/marco/Desktop/coursera/Google data analytics course/capstone_project/2021_06_2022_05_divvy-tripdata")
...
## by checking the structure it is clear all the loaded csv filles have 13 variables and differ in length. It is there fore possible to combine/merge them all together. For this,there are a number of ways we could use bind_rows() or rbind(). here i use bind_rows from the tidyverse package
```{r}
